...
Après avoir reçu le nombre attendu de noms de fichiers, le client répond par `OK`.
...
Une fois qu'il a reçu soit la réponse `Unknown`, soit la totalité des octets attendus pour le fichier, le client envoie la réponse `OK`.
